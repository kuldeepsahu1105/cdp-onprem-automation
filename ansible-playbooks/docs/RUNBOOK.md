...
| CM Kerberos/KDC not enabled (`kerberized=false`) | On ipaserver: `ipactl status` (KDC must be RUNNING). Re-run `12_setup_freeipa_server.yml` then `28_setup_cm_krbs.yml` |
