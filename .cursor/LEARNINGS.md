...
- Listen **81** (`deployment_portal_http_port`); smoke: `http://<ops-public-ip>:81/`. Vhost FQDN: `portal.<dashed-public-ip>.pvc.cloudera-labs.com` (dashes, not dots in IP segment).
