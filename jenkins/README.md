...
| `STARTSTOP_AUTOMATION` | `run-ec2-startstop-automation.sh` — Ansible on **ipaserver** only; deploys/runs `/root/ptgy_cldr_ec2_strt_stp.sh` (`EC2_STARTSTOP_OPERATION`, `EC2_STARTSTOP_GROUPS`, `ENVIRONMENT` tag) |
